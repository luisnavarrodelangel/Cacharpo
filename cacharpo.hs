...
import Sound.OSC
import Sound.OSC.Transport.FD as TF
...
main = do
  melNet <- loadNetwork "/home/lui/Cacharpo/nets/melodyNets/melUltimate_Net-0.001_610.nn"
  tecladoNet <- loadNetwork "/home/lui/Cacharpo/nets/tecladoNets/tecladoUltimate_Net-0.001_285.nn" --285
  bajoNet <- loadNetwork "/home/lui/Cacharpo/nets/bajoNets/bajoUltimate_Net-0.001_283.nn" --544
  guiroNet <- loadNetwork "/home/lui/Cacharpo/nets/guiroNets/guiroUltimate_Net-0.001_87.nn"
  cowbellNet <- loadNetwork "/home/lui/Cacharpo/nets/cowbellNets/cowbellUltimate_Net-0.001_559.nn"
  kickNet <- loadNetwork "/home/lui/Cacharpo/nets/kickNets/kickUltimate_Net-0.001_1285.nn" --1836
  pitchRecognitionNet <- loadNetwork "/home/lui/Cacharpo/nets/pitchRecoNets/c-b+chCmajorScale_Net-0.001_2182.nn"
  energyNet <- loadNetwork "/home/lui/Cacharpo/nets/energyNets/energy_Net-0.001_1554.nn"
  putStrLn "Cacharpo status: listening"
  let t = udpServer "127.0.0.1" port
  m <- openUDP "127.0.0.1" 57120
  TF.withTransport t (oscHandler2 m melNet tecladoNet bajoNet guiroNet cowbellNet kickNet pitchRecognitionNet energyNet)
...
oscHandler2 :: TF.Transport t => t -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> t -> IO ()
...
g :: TF.Transport t => t -> t -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> Network Float -> [InputsToNetworks] -> IO [InputsToNetworks]
g t m melNet tecladoNet bajoNet guiroNet cowbellNet kickNet pitchRecognitionNet energyNet oldState = do
    x <- (TF.waitFor t fromPacket :: IO InputsToNetworks)
    ...
    TF.sendMessage m $ message "/n" out
    --print $ out
    --print outLoudness'
    --print outRoles'
